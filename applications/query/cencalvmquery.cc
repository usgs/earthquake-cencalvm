...
// ======================================================================
//
// C++ application for querying the USGS San Francisco Bay Area
...
{ // usage
  std::cerr
    ...
    << "  6: Qp\n"
    << "  7: Qs\n"
    << "  8: Depth from free surface (m)\n"
    << "  9: Fault block id\n"
    << "  10: Zone id\n"
    << "  11: Elevation (m) of ground surface at longitude/latitude\n"
    << "\n"
    << "Notes:\n"
    << "\n"
    << "  1. Values are not interpolated from the Etree database. That is, queries\n"
    << "     for any point within a grid cell in the database will return the\n"
    << "     values for the grid cell that correspond to its centroid.\n"
    << "\n"
